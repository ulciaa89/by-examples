...
class Addfks extends Doctrine_Migration_Base
{
    public function up()
    {
        $this->createForeignKey('article', 'article_created_by_sf_guard_user_id', array(
             'name' => 'article_created_by_sf_guard_user_id',
             'local' => 'created_by',
             'foreign' => 'id',
        ...
        $this->createForeignKey('article', 'article_updated_by_sf_guard_user_id', array(
             'name' => 'article_updated_by_sf_guard_user_id',
             'local' => 'updated_by',
             'foreign' => 'id',
             'foreignTable' => 'sf_guard_user',
             'onUpdate' => NULL,
    ...
    {
        $this->dropForeignKey('article', 'article_created_by_sf_guard_user_id');
        $this->dropForeignKey('article', 'article_updated_by_sf_guard_user_id');
